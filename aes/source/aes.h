/**
  ...
  * @attention
  *           
  * Multiplation tables for AES encryption and method declarations.
  *
  ************************************************************************************
  */
...
#define ROUNDS (10) // How many ROUNDS of encryption there will be
#define NUM_WORDS (4) // Size of key (word = 32 bits)
#define BLOCK_SIZE (16) // Size of each AES block in bytes

//================================Multiplication Tables===============================
// Rijndael S-box table from 
// https://en.wikipedia.org/wiki/Rijndael_S-box
const uint8_t h_SBOX0[256] = {
...
__constant__ uint8_t d_SBOX0[256] = {
	0x63, 0x7c, 0x77, 0x7b, 0xf2, 0x6b, 0x6f, 0xc5, 0x30, 0x01, 0x67, 0x2b, 0xfe, 0xd7, 0xab, 0x76,
	0xca, 0x82, 0xc9, 0x7d, 0xfa, 0x59, 0x47, 0xf0, 0xad, 0xd4, 0xa2, 0xaf, 0x9c, 0xa4, 0x72, 0xc0,
	0xb7, 0xfd, 0x93, 0x26, 0x36, 0x3f, 0xf7, 0xcc, 0x34, 0xa5, 0xe5, 0xf1, 0x71, 0xd8, 0x31, 0x15,
	0x04, 0xc7, 0x23, 0xc3, 0x18, 0x96, 0x05, 0x9a, 0x07, 0x12, 0x80, 0xe2, 0xeb, 0x27, 0xb2, 0x75,
...
// Used to diffenitate between the device and host version of the data
__device__ __host__ uint8_t SBOX0(int i){
#ifdef __CUDA_ARCH__
    return d_SBOX0[i];
#else
    return h_SBOX0[i];
...
// Inverse Rijndael S-box table from 
// https://en.wikipedia.org/wiki/Rijndael_S-box
const uint8_t h_SBOX1[256] = {
...
__constant__ uint8_t d_SBOX1[256] = {
	0x52, 0x09, 0x6a, 0xd5, 0x30, 0x36, 0xa5, 0x38, 0xbf, 0x40, 0xa3, 0x9e, 0x81, 0xf3, 0xd7, 0xfb,
	0x7c, 0xe3, 0x39, 0x82, 0x9b, 0x2f, 0xff, 0x87, 0x34, 0x8e, 0x43, 0x44, 0xc4, 0xde, 0xe9, 0xcb,
	0x54, 0x7b, 0x94, 0x32, 0xa6, 0xc2, 0x23, 0x3d, 0xee, 0x4c, 0x95, 0x0b, 0x42, 0xfa, 0xc3, 0x4e,
	0x08, 0x2e, 0xa1, 0x66, 0x28, 0xd9, 0x24, 0xb2, 0x76, 0x5b, 0xa2, 0x49, 0x6d, 0x8b, 0xd1, 0x25,
...
// Used to diffenitate between the device and host version of the data
__device__ __host__ uint8_t SBOX1(int i){
#ifdef __CUDA_ARCH__
    return d_SBOX1[i];
#else
    return h_SBOX1[i];
...
// Galois Field multiplication table from
// https://en.wikipedia.org/wiki/Rijndael_MixColumns
const uint8_t h_GMULBY2[256] = {
...
__constant__ uint8_t d_GMULBY2[256] = {
	0x00, 0x02, 0x04, 0x06, 0x08, 0x0a, 0x0c, 0x0e, 0x10, 0x12, 0x14, 0x16, 0x18, 0x1a, 0x1c, 0x1e,
	0x20, 0x22, 0x24, 0x26, 0x28, 0x2a, 0x2c, 0x2e, 0x30, 0x32, 0x34, 0x36, 0x38, 0x3a, 0x3c, 0x3e,
	0x40, 0x42, 0x44, 0x46, 0x48, 0x4a, 0x4c, 0x4e, 0x50, 0x52, 0x54, 0x56, 0x58, 0x5a, 0x5c, 0x5e,
	0x60, 0x62, 0x64, 0x66, 0x68, 0x6a, 0x6c, 0x6e, 0x70, 0x72, 0x74, 0x76, 0x78, 0x7a, 0x7c, 0x7e,
...
// Used to diffenitate between the device and host version of the data
__device__ __host__ uint8_t GMULBY2(int i){
#ifdef __CUDA_ARCH__
    return d_GMULBY2[i];
#else
    return h_GMULBY2[i];
...
__constant__ uint8_t d_GMULBY3[256] = {
	0x00, 0x03, 0x06, 0x05, 0x0c, 0x0f, 0x0a, 0x09, 0x18, 0x1b, 0x1e, 0x1d, 0x14, 0x17, 0x12, 0x11,
	0x30, 0x33, 0x36, 0x35, 0x3c, 0x3f, 0x3a, 0x39, 0x28, 0x2b, 0x2e, 0x2d, 0x24, 0x27, 0x22, 0x21,
	0x60, 0x63, 0x66, 0x65, 0x6c, 0x6f, 0x6a, 0x69, 0x78, 0x7b, 0x7e, 0x7d, 0x74, 0x77, 0x72, 0x71,
	0x50, 0x53, 0x56, 0x55, 0x5c, 0x5f, 0x5a, 0x59, 0x48, 0x4b, 0x4e, 0x4d, 0x44, 0x47, 0x42, 0x41,
...
// Used to diffenitate between the device and host version of the data
__device__ __host__ uint8_t GMULBY3(int i){
#ifdef __CUDA_ARCH__
    return d_GMULBY3[i];
#else
    return h_GMULBY3[i];
...
__constant__ uint8_t d_GMULBY9[256] = {
	0x00, 0x09, 0x12, 0x1b, 0x24, 0x2d, 0x36, 0x3f, 0x48, 0x41, 0x5a, 0x53, 0x6c, 0x65, 0x7e, 0x77,
	0x90, 0x99, 0x82, 0x8b, 0xb4, 0xbd, 0xa6, 0xaf, 0xd8, 0xd1, 0xca, 0xc3, 0xfc, 0xf5, 0xee, 0xe7,
	0x3b, 0x32, 0x29, 0x20, 0x1f, 0x16, 0x0d, 0x04, 0x73, 0x7a, 0x61, 0x68, 0x57, 0x5e, 0x45, 0x4c,
	0xab, 0xa2, 0xb9, 0xb0, 0x8f, 0x86, 0x9d, 0x94, 0xe3, 0xea, 0xf1, 0xf8, 0xc7, 0xce, 0xd5, 0xdc,
...
// Used to diffenitate between the device and host version of the data
__device__ __host__ uint8_t GMULBY9(int i){
#ifdef __CUDA_ARCH__
    return d_GMULBY9[i];
#else
    return h_GMULBY9[i];
...
__constant__ uint8_t d_GMULBY11[256] = {
	0x00, 0x0b, 0x16, 0x1d, 0x2c, 0x27, 0x3a, 0x31, 0x58, 0x53, 0x4e, 0x45, 0x74, 0x7f, 0x62, 0x69,
	0xb0, 0xbb, 0xa6, 0xad, 0x9c, 0x97, 0x8a, 0x81, 0xe8, 0xe3, 0xfe, 0xf5, 0xc4, 0xcf, 0xd2, 0xd9,
	0x7b, 0x70, 0x6d, 0x66, 0x57, 0x5c, 0x41, 0x4a, 0x23, 0x28, 0x35, 0x3e, 0x0f, 0x04, 0x19, 0x12,
	0xcb, 0xc0, 0xdd, 0xd6, 0xe7, 0xec, 0xf1, 0xfa, 0x93, 0x98, 0x85, 0x8e, 0xbf, 0xb4, 0xa9, 0xa2,
...
// Used to diffenitate between the device and host version of the data
__device__ __host__ uint8_t GMULBY11(int i){
#ifdef __CUDA_ARCH__
    return d_GMULBY11[i];
#else
    return h_GMULBY11[i];
...
__constant__ uint8_t d_GMULBY13[256] = {
	0x00, 0x0d, 0x1a, 0x17, 0x34, 0x39, 0x2e, 0x23, 0x68, 0x65, 0x72, 0x7f, 0x5c, 0x51, 0x46, 0x4b,
	0xd0, 0xdd, 0xca, 0xc7, 0xe4, 0xe9, 0xfe, 0xf3, 0xb8, 0xb5, 0xa2, 0xaf, 0x8c, 0x81, 0x96, 0x9b,
	0xbb, 0xb6, 0xa1, 0xac, 0x8f, 0x82, 0x95, 0x98, 0xd3, 0xde, 0xc9, 0xc4, 0xe7, 0xea, 0xfd, 0xf0,
	0x6b, 0x66, 0x71, 0x7c, 0x5f, 0x52, 0x45, 0x48, 0x03, 0x0e, 0x19, 0x14, 0x37, 0x3a, 0x2d, 0x20,
...
// Used to diffenitate between the device and host version of the data
__device__ __host__ uint8_t GMULBY13(int i){
#ifdef __CUDA_ARCH__
    return d_GMULBY13[i];
#else
    return h_GMULBY13[i];
...
__constant__ uint8_t d_GMULBY14[256] = {
	0x00, 0x0e, 0x1c, 0x12, 0x38, 0x36, 0x24, 0x2a, 0x70, 0x7e, 0x6c, 0x62, 0x48, 0x46, 0x54, 0x5a,
	0xe0, 0xee, 0xfc, 0xf2, 0xd8, 0xd6, 0xc4, 0xca, 0x90, 0x9e, 0x8c, 0x82, 0xa8, 0xa6, 0xb4, 0xba,
	0xdb, 0xd5, 0xc7, 0xc9, 0xe3, 0xed, 0xff, 0xf1, 0xab, 0xa5, 0xb7, 0xb9, 0x93, 0x9d, 0x8f, 0x81,
	0x3b, 0x35, 0x27, 0x29, 0x03, 0x0d, 0x1f, 0x11, 0x4b, 0x45, 0x57, 0x59, 0x73, 0x7d, 0x6f, 0x61,
...
// Used to diffenitate between the device and host version of the data
__device__ __host__ uint8_t GMULBY14(int i){
#ifdef __CUDA_ARCH__
    return d_GMULBY14[i];
#else
    return h_GMULBY14[i];
...
// Powers of x mod poly in GF(2). Used for round constant and the table is from
// https://en.wikipedia.org/wiki/AES_key_schedule
const uint8_t h_powx[16] = {
	0x01,
	0x02,
	0x04,
	0x08,
...
__constant__ uint8_t d_powx[16] = {
	0x01,
	0x02,
	0x04,
	0x08,
...
// Used to diffenitate between the device and host version of the data
__device__ __host__ uint8_t powx(int i){
#ifdef __CUDA_ARCH__
    return d_powx[i];
#else
    return h_powx[i];
